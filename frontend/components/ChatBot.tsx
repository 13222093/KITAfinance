  ...
  return (
    <>
      ...
      <button
        ...
        className="hidden md:flex fixed bottom-6 right-4 md:right-8 w-20 h-20 bg-gradient-to-r from-[#0284C7] to-[#06B6D4] text-white rounded-full shadow-2xl hover:scale-110 transition-transform items-center justify-center z-50"
      >
        {isOpen ? (
