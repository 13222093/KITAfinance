...
import { ArrowLeft, TrendingDown, TrendingUp, AlertCircle, Target, Shield, DollarSign, Award, ArrowRight } from 'lucide-react';
...
export default function BuyPut() {
  ...
  // Mock realistic orders (Buy Put = isCall:false, isLong:true)
  const mockOrders = [
    {
      asset: 'BTC',
      strikePrice: '92000',
    ...
    },
    {
      ...
      strikePrice: '90000',
      premium: '580',
      expiry: Math.floor(Date.now() / 1000) + (5 * 24 * 60 * 60),
      apy: '148',
      potentialReturn: '175%',
      currentPrice: '98500'
    },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white/95 backdrop-blur-sm rounded-3xl p-6 md:p-8 shadow-2xl border-4 border-white/50">
                <div className="flex items-start gap-4 md:gap-6 mb-6">
                  <div className="w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-red-500 to-orange-500 rounded-2xl flex items-center justify-center shadow-lg transform rotate-3 hover:rotate-6 transition-transform flex-shrink-0">
              ...
              <div className="bg-white/95 backdrop-blur-sm rounded-3xl p-6 md:p-8 shadow-2xl border-4 border-white/50">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-6">
                  {benefits.map((benefit, index) => {
                    ...
                    return (
                      <div key={index} className="flex items-start gap-3 md:gap-4 p-3 md:p-4 bg-red-50 rounded-xl md:rounded-2xl border border-red-100 hover:bg-red-100 transition-colors">
                        <div className="w-10 h-10 md:w-12 md:h-12 bg-red-200 rounded-lg md:rounded-xl flex items-center justify-center flex-shrink-0">
                          <Icon className="w-5 h-5 md:w-6 md:h-6 text-red-700" />
                        </div>
                        <div>
                ...
                <div className="space-y-4 md:space-y-6">
                  {howItWorks.map((item) => (
                    <div key={item.step} className="flex items-start gap-3 md:gap-6">
                      <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-red-500 to-orange-500 rounded-lg md:rounded-xl flex items-center justify-center text-white font-black text-lg md:text-xl shadow-lg flex-shrink-0">
                        {item.step}
                      </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white/95 backdrop-blur-sm rounded-3xl p-6 md:p-8 shadow-2xl border-4 border-white/50 sticky top-24">
                ...
                <p className="text-sm md:text-base text-gray-600 font-medium mb-4 md:mb-6">Order put option untuk profit dari penurunan. Harga dalam USDC, konversi Rupiah otomatis.</p>
                  ...
                  {mockOrders
                    ...
                    .map((order, index) => {
                      const gradientConfigs = [
                        { border: 'border-red-300', badge: 'bg-red-100 text-red-700 border-red-300' },
                        { border: 'border-orange-300', badge: 'bg-orange-100 text-orange-700 border-orange-300' },
                        { border: 'border-rose-300', badge: 'bg-rose-100 text-rose-700 border-rose-300' },
                      ];
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center justify-between mb-3 md:mb-4">
                            ...
                            <span className="text-[10px] md:text-xs text-gray-500 font-semibold">Buy Put</span>
                          </div>
                          ...
                          <div className="mb-3 md:mb-4">
                            ...
                            <p className="text-[10px] md:text-xs text-red-600 font-bold mt-1">
                              Harga Sekarang: ${parseFloat(order.currentPrice).toLocaleString()}
                            </p>
                          </div>

                          <div className="grid grid-cols-2 gap-2 md:gap-3 mb-4 md:mb-6">
                            <div className="bg-red-50 rounded-lg md:rounded-xl p-2 md:p-3 border-2 border-red-200">
                              <p className="text-[10px] md:text-xs text-red-700 mb-0.5 md:mb-1 font-bold">💰 Premium</p>
                              <p className="text-sm md:text-base font-black text-red-600">{premium.toFixed(0)} USDC</p>
                              <p className="text-[10px] md:text-xs text-red-600 font-medium">≈ Rp {toRupiah(premium)}</p>
                            </div>
                            <div className="bg-orange-50 rounded-lg md:rounded-xl p-2 md:p-3 border-2 border-orange-200">
                              <p className="text-[10px] md:text-xs text-orange-700 mb-0.5 md:mb-1 font-bold">📉 Return</p>
                              <p className="text-sm md:text-base font-black text-orange-600">{order.potentialReturn}</p>
                            </div>
                          ...
                          <button
                            className="w-full bg-gradient-to-r from-red-500 to-orange-500 text-white px-4 md:px-6 py-2.5 md:py-3 rounded-xl md:rounded-2xl text-sm md:text-base font-bold shadow-[0_4px_0_0_rgba(239,68,68,0.4)] md:shadow-[0_6px_0_0_rgba(239,68,68,0.4)] hover:shadow-[0_6px_0_0_rgba(239,68,68,0.4)] md:hover:shadow-[0_8px_0_0_rgba(239,68,68,0.4)] hover:-translate-y-1 active:translate-y-1 active:shadow-[0_2px_0_0_rgba(239,68,68,0.4)] transition-all flex items-center justify-center gap-2"
                          >
                            Beli Put Ini
